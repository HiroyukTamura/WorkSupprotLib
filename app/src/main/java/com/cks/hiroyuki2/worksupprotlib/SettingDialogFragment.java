...
//                    upDateEmail(user, inputStr);
    ...
    private AlertDialog makeDialog(@StringRes int titleId, @StringRes int messageId){
        ...
        } else if (titleId == R.string.input_currentPw || titleId == R.string.input_newPw) {
            edit.setHint(messageId);
            edit.setInputType(InputType.TYPE_TEXT_VARIATION_PASSWORD);
        } else if (titleId == R.string.input_mail) {
...
//                .setTitle(titleId)
        ...
        if (titleId == R.string.input_name || titleId ==  R.string.input_currentPw || titleId ==  R.string.input_newPw){
